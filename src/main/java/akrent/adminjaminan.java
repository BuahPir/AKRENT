 ...
 * @author BuahPir
 */
public class adminjaminan extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminjaminan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
